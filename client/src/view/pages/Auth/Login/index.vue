    ...
    <div class="app-login">
        ...
        <div class="login-bottom">
            ...
            <div class="btn-signup">
                ...
                <span @click="handleRegisterModal">
                    Đăng ký ngay
                </span>
            </div>
        </div>
...
// import { AuthAction } from '@/store/modules/auth/types.actions.js'
...
const handleCloseModal = () => {
    return store.dispatch('common/CLOSE_MODAL_LOGIN')
}
const handleRegisterModal = () => {
    return store.dispatch('common/OPEN_MODAL_REGISTER')
}
