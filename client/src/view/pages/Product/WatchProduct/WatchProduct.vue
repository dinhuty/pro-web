            ...
            <div class="filter-options">
                <div class="filter">
                    ...
                    <div class="options">
                        ...
                        <div class="option" v-for="category in watchCategories" :key="category.id">
                ...
                <div class="filter">
                    ...
                    <div class="options">
                        ...
                        <div class="option" v-for="brand in watchBrands" :key="brand.id">
                            <input type="radio" v-model="selected.brand" :id="brand.value" :name="brand.value"
                                :value="brand.value">
                            <label :for="brand.value">{{ brand.name }}</label>
                        </div>
                    </div>
                </div>
            </div>
...
import { watchBrands, watchCategories } from '@/utils/filter/watchFilter'
...
onBeforeMount(() => {
    const { category, brand } = route.query;
    if (category) {
