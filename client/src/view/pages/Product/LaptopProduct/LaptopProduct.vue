...
import { brands, options, prices } from '@/utils/filter/laptopFilter'
...
watch([() => selected.brand
    ...
    , async ([newBrand, newOption, newPrice, sort]) => {
        ...
        try {
            await store.dispatch(`product/${ProductAction.remote.FETCH_LAPTOP}`, { category: 'laptop', query: selected });
